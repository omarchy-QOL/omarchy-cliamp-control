...
Validated on optiplex-sff with Omarchy `4.0.2`, Quickshell `0.3.1`,
Qt `6.11.2`, and Hyprland `0.56.2`. The plugin requires the native Lua and
plugin settings APIs used by those versions.
